...
FUNC_BASICTYPE_LITERALISE(boolean)
FUNC_BASICTYPE_LITERALISE(byte)
FUNC_BASICTYPE_LITERALISE(char)
FUNC_BASICTYPE_LITERALISE(double)
FUNC_BASICTYPE_LITERALISE(float)
FUNC_BASICTYPE_LITERALISE(int)
FUNC_BASICTYPE_LITERALISE(int16_t)
FUNC_BASICTYPE_LITERALISE(int32_t)
FUNC_BASICTYPE_LITERALISE(int64_t)
FUNC_BASICTYPE_LITERALISE(int8_t)
FUNC_BASICTYPE_LITERALISE(int_fast16_t)
FUNC_BASICTYPE_LITERALISE(int_fast32_t)
FUNC_BASICTYPE_LITERALISE(int_fast64_t)
FUNC_BASICTYPE_LITERALISE(int_fast8_t)
FUNC_BASICTYPE_LITERALISE(intmax_t)
FUNC_BASICTYPE_LITERALISE(intptr_t)
FUNC_BASICTYPE_LITERALISE(llong)
FUNC_BASICTYPE_LITERALISE(long)
FUNC_BASICTYPE_LITERALISE(ptr)
FUNC_BASICTYPE_LITERALISE(short)
FUNC_BASICTYPE_LITERALISE(size_t)
FUNC_BASICTYPE_LITERALISE(uchar)
FUNC_BASICTYPE_LITERALISE(uint)
FUNC_BASICTYPE_LITERALISE(uint16_t)
FUNC_BASICTYPE_LITERALISE(uint32_t)
FUNC_BASICTYPE_LITERALISE(uint64_t)
FUNC_BASICTYPE_LITERALISE(uint8_t)
FUNC_BASICTYPE_LITERALISE(uint_fast16_t)
FUNC_BASICTYPE_LITERALISE(uint_fast32_t)
FUNC_BASICTYPE_LITERALISE(uint_fast64_t)
FUNC_BASICTYPE_LITERALISE(uint_fast8_t)
FUNC_BASICTYPE_LITERALISE(uintmax_t)
FUNC_BASICTYPE_LITERALISE(uintptr_t)
FUNC_BASICTYPE_LITERALISE(ullong)
FUNC_BASICTYPE_LITERALISE(ulong)
FUNC_BASICTYPE_LITERALISE(ushort)
